...
parser.add_argument('--data-dir', type=str,
                    default='pth/metr.pth',
                    help='Directory to save the best model.')
# Customized arguments
parser.add_argument('--log-dir', type=str,
                    default='log/gwn_metr.txt')
...
def main():
    ...
    dataloader = util.load_discrete_dataset(args.data, args.batch_size, args.batch_size, args.batch_size)
    ...
    engine = trainer_nb(args.in_dim, args.seq_length, args.num_nodes, args.nhid, args.dropout,
    ...
    for iter, (x, y) in enumerate(dataloader['test_loader'].get_iterator()):
        ...
        testx = testx.transpose(1,3)
        with torch.no_grad():
            preds, preds_var = engine.model(testx)
    ...
    handler.flush()
    torch.save(engine.model.state_dict(), args.data_dir +"_exp"+str(args.expid)+"_best.pth")
